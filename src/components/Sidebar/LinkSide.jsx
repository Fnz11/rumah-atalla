  ...
  return (
    <>
      <Link
        ...
        } flex items-center justify-between text-thirdyThin drop-shadow-sm group mx-2 px-4 my-1 rounded-2xl py-5 lg:py-[0.6rem] hover:bg-primaryThin transition-all duration-300 `}
      >
