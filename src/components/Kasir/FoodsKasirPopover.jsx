  ...
  return (
    <>
      <motion.div
        ...
        key={props._id}
        className="flex w-full  bg-white my-1 shadow-md py-2 min-h-[5.5rem] text-gray-600  text-[0.7rem] sm:text-sm items-center rounded-2xl px-2 relative inset-[0.2rem]"
      >
