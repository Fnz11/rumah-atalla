      ...
      <div
        ...
        className={`${
          props?.data?.store === "web"
            ...
            : ""
        } rounded-2xl my-3 w-full relative  bg-section text-primaryDark text-[0.7rem] leading-5 sm:leading-normal md:text-base shadow-md border-b-2 inset-[0.2rem]  p-3`}
      >
