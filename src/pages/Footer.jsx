    ...
    <>
      <footer className="text-gray-600 body-font">
        <div className="container py-20 mx-auto ">
          <div className="flex flex-wrap md:text-left text-center justify-center w-full -mb-">
            <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
              {/* LOGO */}
              <div className="flex mr-10">
                <img
                  src="/LogoGreen.png"
                  className="w-[3.7rem] scale-[1.9] -mt-2 h-[3.7rem]"
                  alt="Logo"
                />
                <div className="uppercase ml-1 text-base text-primaryNormal ">
        ...
        <div className="border-t border-gray-200">
          <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
            <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
              ...
              <button className="inline-flex text-white bg-primaryNormal border-0 py-2 px-6 focus:outline-none hover:bg-primaryDark rounded">
                Search
              </button>
            </div>
